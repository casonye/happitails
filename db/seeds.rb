...
s.clients.create([
  ...
  {name: "Chidinma", age: 33, photo: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTR9HQ3W6803huET6Y1p9zy-m3m8YVy-7qtd5dImKt0x8B0bid_dcHYVw"},
...
Client.fifth.animals.create([
  {name: "Jase", species: "dog", photo: "https://s-media-cache-ak0.pinimg.com/736x/78/2a/76/782a764ed2f08549286be13c4e7a69fb.jpg"}
])
